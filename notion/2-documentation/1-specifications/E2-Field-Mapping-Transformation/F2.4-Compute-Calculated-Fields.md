...
**Calculation Types:**
- **Derivation**: Transform one field into another (heading → cardinal direction)
...
**Examples:**
- `location.cardinal_direction` = Derived from `location.heading` (0-359° → N, NE, E, etc.)
...
- **[Mapping Fields Database](../databases/mapping-fields/README.md)**: Calculation rules
