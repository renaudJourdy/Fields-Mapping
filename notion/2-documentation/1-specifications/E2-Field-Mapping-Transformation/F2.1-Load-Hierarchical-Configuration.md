...
Before applying any field mappings (F2.2-F2.6), the system must load the appropriate configuration for the asset being processed. Configuration is hierarchical: default → customer → asset group → asset.
...
### AC1 – Load Hierarchical Configuration
...
- **[Epic 5 - Configuration & Management](../E5-Configuration-Management/README.md)**: Configuration management
