...
```json
{
  ...
  "_metadata": {
    "transformation": {
      ...
      "config_levels": ["default", "customer:acme"],
...
**Note:** Transformation metadata is required for data lineage, debugging, and historical recalculation. See [Data Lineage Documentation](../../6-data-quality/data-lineage.md) for complete specification.
