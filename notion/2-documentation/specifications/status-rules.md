...
2. [Connectivity Status](#1-connectivity-status)
3. [Immobilization Status](#2-immobilization-status)
4. [Engine Status](#3-engine-status)
5. [Transit Status](#4-transit-status)
...
- **standby**:
  ...
  - Map from telemetry:
    ...
    - Read the specified input: `io.inputs[1]` = 0 OR `io.inputs.ignition` = 0
