...
This document provides a structured breakdown of all features required for the Fleeti Telemetry Mapping system, organized by epic. Features are focused on essential functionality (80/20 principle) to support both web and mobile Live Map applications.

**Key Context:**
- All features must work with **Data Forwarding** and **Fleeti Telemetry Mapping**
- Backend provides **WebSocket streams** for real-time data (web and mobile)
- Backend provides **REST APIs** for historical data and snapshots
- Provider-agnostic architecture must be ready from the start

---

# Epic Breakdown

## [📥 Epic 1: Provider Ingestion & Data Forwarding](./E1-Ingestion-Provider-Integration/README.md)

**Link to:** [E1 – Ingestion & Provider Integration](./E1-Ingestion-Provider-Integration/README.md)
...
## [🔄 Epic 2: Transformation Pipeline](./E2-Field-Mapping-Transformation/README.md)

**Link to:** [E2 – Field Mapping & Transformation](./E2-Field-Mapping-Transformation/README.md)
...
## [✅ Epic 3: Status Computation](./E3-Status-Computation/README.md)

**Link to:** [E3 – Status Computation](./E3-Status-Computation/README.md)
...
## [💾 Epic 4: Storage Strategy](./E4-Storage-Data-Management/README.md)

**Link to:** [E4 – Storage & Data Management](./E4-Storage-Data-Management/README.md)
...
## [🔗 Epic 6: Data Consumption](./E6-API-Consumption/README.md)

**Link to:** [E6 – API & Consumption](./E6-API-Consumption/README.md)
...
## ⚙️ Epic 7: Provider Priority Configuration

**Link to:** [Provider Priority Configuration](./provider-priority-configuration.md)
...
- **[Databases](../1-databases/README.md)**: Provider Fields, Fleeti Fields, Mapping Fields, YAML Configuration
...
- **[Provider Priority Configuration](./provider-priority-configuration.md)**: Multi-gateway provider selection rules
